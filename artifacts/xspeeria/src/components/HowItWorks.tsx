...
const steps = [
  ...
  {
    tab: "4. Deposit",
    num: "04", title: "Deposit to Partner Bank",
    desc: "Both parties deposit funds into licensed partner bank accounts. The bank holds and validates each deposit independently. The escrow account is owned and operated exclusively by the bank — Xspeeria never takes custody of your funds.",
    items: [
      { icon: "🏦", bg: "rgba(16,185,129,.1)", label: "Funds Held by Partner Bank", sub: "Bank-operated · Not Xspeeria-held" },
      { icon: "✅", bg: "rgba(245,158,11,.1)", label: "Both Deposits Confirmed", sub: "Bank validates each side independently" },
      { icon: "📡", bg: "rgba(26,86,219,.1)", label: "Confirmation Event Sent", sub: "API notification to Xspeeria · Timestamped" },
    ],
    pips: [true, true, true, true, false, false],
  },
  {
    tab: "5. Settle",
    num: "05", title: "Bank Executes Settlement",
    desc: "The licensed partner bank simultaneously releases each party's funds once both deposits are confirmed. Xspeeria only receives the settlement confirmation via API — we never touch, hold, or disburse funds.",
    items: [
      { icon: "⚡", bg: "rgba(16,185,129,.1)", label: "Bank Releases Funds", sub: "Simultaneous release by licensed institution" },
      { icon: "🔀", bg: "rgba(26,86,219,.1)", label: "Split Settlement Available", sub: "Up to 5 beneficiary accounts" },
      { icon: "✅", bg: "rgba(245,158,11,.1)", label: "Transaction Closed", sub: "Regulatorily traceable · Full audit trail" },
    ],
