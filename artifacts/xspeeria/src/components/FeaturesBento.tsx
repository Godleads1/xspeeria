...
const features = [
  ...
  },
  {
    ...
    tag: "Zero-Risk", tagClass: "bt-mint", wide: false, delay: ".07s",
  },
  {
    iconClass: "bi-gold",
    ...
    tag: "AI-Driven", tagClass: "bt-blue", wide: false, delay: ".14s",
  },
  {
    iconClass: "bi-mint",
    ...
    tag: "Flexible", tagClass: "bt-mint", wide: true, delay: ".2s",
  },
  {
    iconClass: "bi-purple",
    ...
    tag: "Optional", tagClass: "bt-blue", wide: false, delay: ".27s",
  },
  {
    iconClass: "bi-red",
    ...
    tag: "KYC/AML", tagClass: "bt-mint", wide: false, delay: ".34s",
  },
];
