    ...
    <section id="hero" ref={heroRef}>
      <div className="container">
        <div className="hero-grid">
          <div>
            <div className="badge fade-up" style={{ transitionDelay: "0s" }}>
              <div className="badge-dot" aria-hidden="true" />
              Bank-Settled FX Infrastructure
            </div>

            <h1 className="hero-headline fade-up" aria-label="Exchange at the real market rate." style={{ transitionDelay: ".1s" }}>
            ...
            <p className="hero-sub fade-up" style={{ transitionDelay: ".18s" }}>Connect with verified members across 8 countries. Settlements flow through licensed partner banks — no custody, no hidden fees, just the mid-market rate.</p>

            <div className="hero-trust fade-up" aria-label="User ratings" style={{ transitionDelay: ".25s" }}>
            ...
            <div className="hero-ctas fade-up" style={{ transitionDelay: ".32s" }}>
            ...
            <div className="hero-store-badges fade-up" aria-label="Download the app" style={{ transitionDelay: ".4s" }}>
            ...
            <div className="social-proof fade-up" aria-label="Platform statistics" style={{ transitionDelay: ".5s" }}>
